          ...
          <div className="z-10 relative">
            ...
            <div className="btns flex gap-2 items-center">
              ...
              <a
                href="/Youssef_Moussaddeq_CV.pdf"
                target="_blank"
                className="inline-flex items-center gap-2 px-2.5 py-2.5 border-2 border-green-100 text-black/40 rounded-lg font-semibold hover:text-white hover:bg-green-300  transition-all mb-8"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
